...
test_plan_md = """# VWO Login Dashboard - Test Plan
...
md_path = "Testplan_Template/VWO_Login_Testplan.md"
pdf_path = "Testplan_Template/VWO_Login_Testplan.pdf"
...
generate_pdf(test_plan_md, pdf_path)
print("Successfully generated MD and PDF files in Testplan_Template directory.")
